...
@Mod("msat")
public class MsatMod {
	public static final Logger LOGGER = LogManager.getLogger(MsatMod.class);
	public static final String MODID = "msat";

	public MsatMod(IEventBus modEventBus) {
